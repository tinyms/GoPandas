...
public class OrgDeptController {
    ...
    @RequestMapping(value ="/dept/all",method = {RequestMethod.POST,RequestMethod.GET})
    ...
    @RequestMapping(value ="/dept/by_id",method = {RequestMethod.POST,RequestMethod.GET})
    ...
    @RequestMapping(value ="/dept/by_deptcode",method = {RequestMethod.POST,RequestMethod.GET})
    ...
    @RequestMapping(value ="/dept/by_deptname",method = {RequestMethod.POST,RequestMethod.GET})
    ...
    @RequestMapping(value ="/dept/saveorupdate",method = {RequestMethod.POST,RequestMethod.GET})
